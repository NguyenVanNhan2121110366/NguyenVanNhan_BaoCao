...
class BrandController extends Controller
{
    ...
    public function all_brand_product(){
        ...
        $manager_brand_product = view('backend.dashboard.brand.all_brand')->with('all_brand_product',$all_brand_product);
        return view('layouts.admin')->with('backend.dashboard.brand.all_brand',$manager_brand_product);
    }
