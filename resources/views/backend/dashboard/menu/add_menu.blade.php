            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="position-center">
                        <form role="form" action="{{ URL::to('/admin/save-menu') }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="resize: none" rows="5" class="form-control" name="menu_desc" id="exampleInputPassword1"
                                    placeholder="Mô tả danh mục"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Link</label>
                                <input style="text" name="menu_link" class="form-control" id="exampleInputEmail1"
                                    placeholder="Tên danh mục">
                            </div>
