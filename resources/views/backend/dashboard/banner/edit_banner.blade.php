                            ...
                            <form role="form" action="{{ URL::to('/admin/update-banner/' . $edit_value->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="banner_name" class="form-control"
                                        value="{{ $edit_value->name }}" id="exampleInputEmail1"
                                        placeholder="Tên tiêu đề Banner">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Hình ảnh banner</label>
                                    <input type="file" name="image" class="form-control" id="exampleInputEmail1">
                                    <img src="{{ asset('uploads/banner/' . $edit_value->image) }}" height="100"
                                        width="100">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Đường link</label>
                                    <input type="text" name="banner_link" class="form-control"
                                        value="{{ $edit_value->link }}" id="exampleInputEmail1"
                                        placeholder="Đường link Banner">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none" rows="5" class="form-control" name="banner_desc" id="exampleInputPassword1"
                                        placeholder="Mô tả Banner">{{ $edit_value->description }}</textarea>
                                </div>
