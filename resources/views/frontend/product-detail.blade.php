        ...
        <div class="col-sm-7">
            <div class="product-information"><!--/product-information-->
                ...
                <span>
                    ...
                    <input name="quanty" type="number" min="1" value="1" />
                    <input name="productid_hidden" type="hidden" value="{{ $product->id }}" />
                    <a href="{{ URL::to('/add-cart/' . $product->id) }}">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    @foreach ($relate as $key => $lienquan)
                        <a href="{{ URL::to('/chi-tiet-san-pham/' . $lienquan->id) }}">
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{ asset('uploads/product/' . $lienquan->image) }}" alt="" />
                                        ...
                                        <a href="{{ URL::to('/chi-tiet-san-pham/' . $lienquan->id) }}">
                                            <div class="product-overlay">
                                                <div class="overlay-content">
                                                    <img src="{{ asset('uploads/product/' . $lienquan->image) }}"
                                                        alt="" />
                                                    <h2>{{ number_format($lienquan->price) . ' ' . 'VND' }}</h2>
                                                    <p>{{ $lienquan->name }}</p>
                                                    <a href="#" class="btn btn-default add-to-cart"><i
