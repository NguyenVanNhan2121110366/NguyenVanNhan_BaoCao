                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                <li><a href="{{ URL::to('/checkout-login') }}"><i class="fa fa-user"></i> Tài khoản</a>
                                </li>
                                <li><a href="#"><i class="fa fa-star"></i> yêu thích</a></li>
                                <?php 
                                    $user_id = Session::get('user_id');
                                    $delivery_id = Session::get('delivery_id');
                                    if($user_id != NULL && $delivery_id==NULL){
                                ?>
                                ...
                                ?>
                                <li><a href="{{ URL::to('/checkout-login') }}"><i class="fa fa-crosshairs"></i> Thanh
                                        toán</a>
                                </li>
                                <?php 
                                    }
                                ...
                                <?php 
                                    ...
                                    if($user_id != NULL && $cart != NULL){
                                ?>
                                <li><a href="{{ URL::to('/cart') }}"><i class="fa fa-shopping-cart"></i> Giở hàng</a>
                                </li>
                                <?php 
                                    } elseif($cart == NULL){
                                ?>
                                <li><a href="{{ URL::to('/trang-chu') }}"><i class="fa fa-shopping-cart"></i> Giỏ
                                        hàng</a></li>
                                <li><span class="empty-cart-message" style="color: red;">Vui lòng thêm sản phẩm vào giỏ
                                        hàng.</span></li>
                                <?php 
                                    }else{
                                ?>
                                ...
                                <?php 
                                    ...
                                    if($user_id != NULL){
                                ?>
                                <li><a href="{{ URL::to('/checkout-logout') }}"><i class="fa fa-lock"></i> Đăng
                                        xuất</a></li>
                                <?php 
                                    } else{
                                ?>
                                <li><a href="{{ URL::to('/checkout-login') }}"><i class="fa fa-lock"></i> Đăng
                                        nhập</a>
                                </li>
                                <?php 
                                    }
                        ...
                        <div class="carousel-inner">
                            ...
                            @foreach ($all_banner as $key => $banner)
                                <div class="item{{ $key == 0 ? ' active' : '' }}">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="{{ asset('../public/uploads/slider/' . $banner->image) }}"
