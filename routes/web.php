...
use App\Http\Controllers\backend\CustommerController;
...
Route::get('/thankyourpay', [CheckoutController::class, 'thankyourpay']);
...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/all-categorypost', [CategoryPostController::class, 'all_categorypost']);
